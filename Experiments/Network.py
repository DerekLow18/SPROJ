...
def main(num):
	...
	neuronPop, popMatrix = readAndCreate("./Syn Weights/groundTruth10.csv")
	...
	numpy.savetxt("./Spike Results/pop10/%02didTimes.csv" % (num),fullMatrix,delimiter=',')
	numpy.savetxt("./Spike Results/pop10/%02dspikeTrains.csv" % (num),temp,delimiter = ',')
	#pylab.figure(2)
