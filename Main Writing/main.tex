...
\begin{minipage}{.49\linewidth}
\centering
\subfloat[]{\label{main:e}\includegraphics[height=5cm,scale=0.4,trim={1cm 1cm 1cm 1cm},clip]{./Figures/"XC Figures"/05CorrGram.pdf}}
\end{minipage}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:f}\includegraphics[height=5cm,scale=0.4,trim={1cm 1cm 2cm 1cm},clip]{./Figures/"XC Figures"/051CorrGram.pdf}}
\end{minipage}
...
\subfloat[]{\label{errorTwoTime:a}\includegraphics[scale=0.55,trim={1cm 0 1cm 0},clip]{./Figures/Errors/twoTimeStepvarSigPOPError.pdf}}
\end{minipage}

\caption{\textbf{Error Convergence of Model On Two Consecutive Time Steps.} Each scatter plot point represents an average of 10 separate runs of the model, each run lasting 100 iterations. (a)Error Convergence on Variable Activation Function Model. The model was trained on a selected timestep of  (b)}
