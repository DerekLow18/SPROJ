...
\begin{minipage}{0.49\linewidth}
\captionsetup{position=top}
\subfloat[]{\label{QQ:a}\includegraphics[scale=0.5,trim={0 0 1cm 0.5cm},clip]{./Figures/DD/gtQQpop50.pdf}}
\end{minipage}
\begin{minipage}{0.50\linewidth}
\captionsetup{position=top}
\subfloat[]{\label{QQ:b}\includegraphics[scale=0.5,trim={0 0 1cm 0.5cm},clip]{./Figures/DD/simulatedvarQQpop50.pdf}}
\end{minipage}
